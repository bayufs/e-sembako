...
<body>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"></div>
                                    <div>Master Partisipan Baru</div>
                                </div>
                            </div>
                        </div>
                        <a href="/">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"></div>
                                    <div>Input Partisipan Baru</div>
                                </div>
                            </div>
                        </div>
                        <a href="/input-partisipan">
                            <div class="panel-footer">
                                <span class="pull-left">Go to page</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
    ...
    <script src="{{ asset('asset/vendor/morrisjs/morris.min.js') }}"></script>
    <script src="{{ asset('asset/data/morris-data.js') }}"></script>
